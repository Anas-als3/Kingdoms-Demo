...
public class KingdomSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            getOrCreateKingdom(KingdomType.SPORTS,       "مملكة الرياضة",   "حرّك جسدك — يتم التحقق عبر أنشطتك على Strava.");
            getOrCreateKingdom(KingdomType.CHARITY,      "مملكة العطاء",   "اعطِ وردّ الجميل — يتم التحقق من تبرّع بنكي عبر Neotek Open Banking.");
            getOrCreateKingdom(KingdomType.VOLUNTEERING, "مملكة التطوع", "اخدم مجتمعك — يتم التحقق من شهادة PDF يفحصها الذكاء الاصطناعي.");
            getOrCreateKingdom(KingdomType.READING,      "مملكة القراءة",   "اقرأ الكتب — يتم التحقق عبر اختبار قصير على WhatsApp (Google Books).");
            getOrCreateKingdom(KingdomType.GAMING,       "مملكة الألعاب",    "ارفع مستواك — يتم التحقق من وقت اللعب والإنجازات على Steam.");
            getOrCreateKingdom(KingdomType.FAITH,        "مملكة الإسلاميات",     "ازدد قربًا — يتم التحقق عبر اختبار على WhatsApp حول محتوى القرآن.");
            getOrCreateKingdom(KingdomType.KNOWLEDGE,    "مملكة المعرفة",  "تعلّم — يتم التحقق عبر اختبار معرفي بالذكاء الاصطناعي.");
            getOrCreateKingdom(KingdomType.NUTRITION,    "مملكة التغذية",  "تغذَّ جيدًا — يتم التحقق من صورة وجبتك بالذكاء الاصطناعي.");
            getOrCreateKingdom(KingdomType.PROGRAMMING,  "مملكة البرمجة", "برمِج — يتم التحقق من نشاطك على GitHub.");
