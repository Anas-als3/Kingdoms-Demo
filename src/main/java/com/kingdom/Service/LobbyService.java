...
public class LobbyService {
    ...
    public void updateLobby(Integer lobbyId, LobbyIN lobbyIn) {
        ...
        if (lobby.getStatus() != LobbyStatus.OPEN) {
            throw new ApiException("لا يمكن تحديث سوى اللوبيات المفتوحة");
        }
    ...
    public Integer createLobby(Integer kingdomId, Integer challengeId, Integer hostPlayerId, LobbyIN lobbyIn) {
        ...
        if (!subscriptionService.isPlayerPremium(hostPlayerId)) {
            throw new ApiException("إنشاء لوبي يتطلب اشتراك بريميوم نشط");
        }
        ...
        if (hostMembership == null) {
            throw new ApiException("يجب أن تنضم إلى هذه المملكة قبل استضافة لوبي فيها");
        }
    ...
    public void cancelLobby(Integer lobbyId, Integer hostPlayerId) {
        ...
        if (!lobby.getHostPlayerId().equals(hostPlayerId)) {
            throw new ApiException("يمكن للمضيف فقط إلغاء هذا اللوبي");
        }
        if (lobby.getStatus() != LobbyStatus.OPEN) {
            throw new ApiException("لا يمكن إلغاء سوى اللوبيات المفتوحة");
        }
        if (isLockedForExit(lobby)) {
            throw new ApiException("لا يمكنك إلغاء هذا اللوبي لأنه يتبقى أقل من 8 ساعات على بدء التحدي");
        }
    ...
    public List<LobbyOut> getPublicLobbiesByKingdom(Integer kingdomId, Integer requesterPlayerId) {
        ...
        if (membership == null) {
            throw new ApiException("يجب أن تنضم إلى هذه المملكة أولًا لرؤية لوبياتها العامة");
        }
        List<LobbyOut> result = new ArrayList<>();
    ...
    public Lobby checkLobby(Integer id) {
        ...
        if (lobby == null) {
            throw new ApiException("اللوبي غير موجود");
        }
        return lobby;
    }
    ...
    public void finishLobby(Integer lobbyId, Integer hostPlayerId, Integer winnerPlayerId) {
        ...
        Lobby lobby = checkLobby(lobbyId);
        if (!lobby.getHostPlayerId().equals(hostPlayerId)) {
            throw new ApiException("يمكن للمضيف فقط إنهاء هذا اللوبي");
        }
        if (lobby.getStatus() != LobbyStatus.ACTIVE) {
            throw new ApiException("لا يمكن إنهاء سوى لوبي نشط");
        }
        ...
        try {
            ...
            if (winnerPlayerId == null) {
                throw new ApiException("تعذّر تحديد الفائز تلقائيًا — معرّف اللاعب الفائز مطلوب");
            }
            if (!lobbyMemberRepository.existsByLobbyIdAndPlayerId(lobbyId, winnerPlayerId)) {
                throw new ApiException("يجب أن يكون الفائز عضوًا في هذا اللوبي");
            }
    ...
    public String suggestLobbyForPlayer(Integer playerId) {
        ...
        if (memberships.isEmpty()) {
            throw new ApiException("اللاعب غير منضم إلى أي مملكة");
        }
        ...
        if (availableLobbies.isEmpty()) {
            throw new ApiException("لا توجد لوبيات عامة مناسبة لهذا اللاعب");
        }
        ...
        if (result == null || result.isBlank()) {
            throw new ApiException("فشل اقتراح الذكاء الاصطناعي");
        }
...
//check
    ...
    private LocalDateTime computeEndsAt(LocalDateTime startsAt, Challenge challenge) {
        return switch (challenge.getPeriod()) {
            ...
            default -> throw new ApiException("فترة غير مدعومة لمدة اللوبي: " + challenge.getPeriod());
        };
    }

    private Integer determineLobbyWinner(Lobby lobby) {
        if (lobby.getChallenge() == null) {
            throw new ApiException("اللوبي لا يحتوي على تحدٍ");
        }
        ...
        throw new ApiException("لا توجد استراتيجية تحديد فائز تلقائية لمصدر التحقق: " + source);
    }
    ...
    private Integer determineKnowledgeWinner(Lobby lobby) {
        ...
        if (bestPlayerId == null) {
            throw new ApiException("لم يتم العثور بعد على نتائج تحدي معرفي لأعضاء هذا اللوبي");
        }
    ...
    private Integer determineFastestWinner(Lobby lobby) {
        ...
        if (fastestPlayerId == null) {
            throw new ApiException("لم يتم العثور بعد على تسليمات تحدٍ موثّقة لأعضاء هذا اللوبي");
        }
