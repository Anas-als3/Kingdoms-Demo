...
public class PlayerAiReportService {
    ...
    private String generateAiReportHtml(Player player, List<KingdomMembership> memberships) {
        ...
        if (html == null || html.isBlank()) {
            throw new ApiException("فشل الذكاء الاصطناعي في إنشاء تقرير اللاعب");
        }
    ...
    private byte[] convertHtmlToPdf(String html) {
        ...
        try {
            ...
            throw new ApiException("فشل إنشاء ملف PDF لتقرير اللاعب: " + e.getMessage());
        }
    }
    ...
    private String cleanAiHtml(String html) {
        ...
        if (html == null || html.isBlank()) {
            throw new ApiException("أعاد الذكاء الاصطناعي محتوى HTML فارغاً");
        }
