...
public class QuranTafsirService {
    ...
    public String getSurahTafseer(Integer surahNumber, Integer fromAyah, Integer toAyah) {
        ...
        if (result.isBlank()) {
            throw new ApiException("لم يتم إرجاع أي تفسير من واجهة Quran Tafseer");
        }
    ...
    private String getAyahTafseer(Integer surahNumber, Integer ayahNumber) {
        ...
        try {
            ...
            throw new ApiException("فشل في الاتصال بواجهة Quran Tafseer: " + e.getMessage());
        }
    }
    ...
    private String getSafeBaseUrl() {
        ...
        if (baseUrl == null || baseUrl.isBlank()) {
            throw new ApiException("عنوان URL الأساسي لواجهة Quran Tafseer غير موجود");
        }
