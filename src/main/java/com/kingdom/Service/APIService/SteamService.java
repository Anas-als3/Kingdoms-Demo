...
public class SteamService {
    ...
    private JsonNode findOwnedGameByName(String steamId, String gameName) {
        ...
        if (raw == null) {
            throw new ApiException("أعاد ستيم استجابة فارغة");
        }
        ...
        try {
            ...
            if (!games.isArray()) {
                throw new ApiException("ألعاب ستيم خاصة أو غير متاحة");
            }
            ...
            throw new ApiException("فشل تحليل استجابة ستيم: " + e.getMessage());
        }
    ...
    private JsonNode getPlayerAchievements(String steamId, Integer appId) {
        ...
        try {
            ...
            if (!achievements.isArray()) {
                throw new ApiException("إنجازات ستيم خاصة أو غير متاحة");
            }
            return achievements;
        } catch (ApiException e) {
            throw e;
