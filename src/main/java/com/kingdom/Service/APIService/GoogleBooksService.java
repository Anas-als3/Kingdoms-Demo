...
public class GoogleBooksService {
    ...
    public List<GoogleBookDTO> findSuitableBooks(
        ...
        if (googleBooksApiKey == null || googleBooksApiKey.isBlank()) {
            throw new ApiException("مفتاح واجهة Google Books غير موجود");
        }
        ...
        for (int startIndex : List.of(0, 40)) {
            ...
            try {
                ...
                throw new ApiException("فشل في تحليل استجابة Google Books: " + e.getMessage());
            }
        }

        if (books.isEmpty()) {
            throw new ApiException("لم يتم العثور على كتب مناسبة وغير مكررة لهذا المستوى وهذه الفترة");
        }
        ...
        for (int attempt = 1; attempt <= maxAttempts; attempt++) {
            ...
            try {
                ...
                if (raw == null || raw.isBlank()) {
                    throw new ApiException("أرجعت Google Books استجابة فارغة");
                }
                ...
                if (e.getStatusCode() == HttpStatus.SERVICE_UNAVAILABLE) {
                    ...
                    if (attempt == maxAttempts) {
                        throw new ApiException("خدمة Google Books غير متاحة مؤقتاً. يرجى المحاولة مرة أخرى لاحقاً.");
                    }
                ...
                throw new ApiException("خطأ في خادم Google Books: " + e.getStatusCode());

            } catch (ApiException e) {
                throw e;

            } catch (Exception e) {
                throw new ApiException("فشل في الاتصال بواجهة Google Books: " + e.getMessage());
            }
        }
    ...
    private void sleepBeforeRetry() {
        try {
            ...
            throw new ApiException("تمت مقاطعة الطلب أثناء إعادة محاولة الاتصال بواجهة Google Books");
        }
    }
    ...
    private int getMinPages(Difficulty difficulty, Period period) {
        ...
        return switch (period) {
            ...
            default -> throw new ApiException("الفترة غير مدعومة");
        };
    }
