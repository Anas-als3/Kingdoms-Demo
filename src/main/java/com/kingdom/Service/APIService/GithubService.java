...
public class GithubService {
    ...
    public boolean verifyRepository(String repoUrl) {
        ...
        try {
            ...
            throw new ApiException("لم يتم العثور على مستودع جيت هب");
        } catch (Exception e) {
            throw new ApiException("فشل الوصول إلى جيت هب: " + e.getMessage());
        }
        ...
        try {
            ...
            throw new ApiException("فشل التحقق من الإيداعات: " + e.getMessage());
        }
    }
    ...
    private String[] extractOwnerAndRepo(String repoUrl) {
        ...
        if (!matcher.find()) {
            throw new ApiException("رابط مستودع جيت هب غير صالح");
        }
    ...
    public boolean verifyRecentCommit(String repoUrl) {
        ...
        try {
            ...
            throw new ApiException("فشل التحقق من آخر إيداع في جيت هب: " + e.getMessage());
        }
    }
}
