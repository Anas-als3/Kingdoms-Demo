...
public class AdminController {
    ...
    public ResponseEntity<?> addUser(@RequestBody @Valid UserIn userIn) {
        ...
        return ResponseEntity.status(200).body(new ApiResponse("تم إنشاء المستخدم بنجاح"));
    }
    ...
    public ResponseEntity<?> updateUser(@PathVariable Integer id, @RequestBody @Valid UserIn userIn) {
        ...
        return ResponseEntity.status(200).body(new ApiResponse("تم تحديث المستخدم بنجاح"));
    }

    @DeleteMapping("/delete/{id}")
    public ResponseEntity<?> deleteUser(@PathVariable Integer id) {
        adminService.deleteUser(id);
        return ResponseEntity.status(200).body(new ApiResponse("تم حذف المستخدم بنجاح"));
    }
    @GetMapping("byID/{id}")
    ...
    public ResponseEntity<?> banPlayer(@PathVariable Integer playerId) {
        ...
        return ResponseEntity.ok(new ApiResponse("تم حظر اللاعب بنجاح"));
    }
    ...
    public ResponseEntity<?> unbanPlayer(@PathVariable Integer playerId) {
        ...
        return ResponseEntity.ok(new ApiResponse("تم رفع الحظر عن اللاعب بنجاح"));
    }
    ...
    public ResponseEntity<?> adjustMembershipXp(@PathVariable Integer membershipId, @PathVariable Integer xp) {
        ...
        return ResponseEntity.ok(new ApiResponse("تم تعديل نقاط الخبرة بنجاح"));
    }
    ...
    public ResponseEntity<?> forceDeleteLobby(@PathVariable Integer lobbyId) {
        ...
        return ResponseEntity.ok(new ApiResponse("تم حذف الردهة قسريًا بنجاح"));
    }
}