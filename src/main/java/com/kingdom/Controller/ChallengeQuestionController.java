...
public class ChallengeQuestionController {
    ...
    public ResponseEntity<?> add(@RequestBody @Valid ChallengeQuestion challengeQuestion) {
        ...
        return ResponseEntity.ok(new ApiResponse("تم إنشاء سؤال التحدي بنجاح"));
    }
    ...
    public ResponseEntity<?> update(
        ...
        return ResponseEntity.ok(new ApiResponse("تم تحديث سؤال التحدي بنجاح"));
    }

    @DeleteMapping("/delete/{id}")
    public ResponseEntity<?> delete(@PathVariable Integer id) {
        challengeQuestionService.deleteChallengeQuestion(id);
        return ResponseEntity.ok(new ApiResponse("تم حذف سؤال التحدي بنجاح"));
    }
