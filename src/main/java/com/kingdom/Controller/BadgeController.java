...
public class BadgeController {
    ...
    public ResponseEntity<?> add(@PathVariable Integer kingdomId, @RequestBody @Valid BadgeIN badge) {
        ...
        return ResponseEntity.ok(new ApiResponse("تم إنشاء الشارة بنجاح"));
    }
    ...
    public ResponseEntity<?> update(@PathVariable Integer id, @RequestBody @Valid BadgeIN badge) {
        ...
        return ResponseEntity.ok(new ApiResponse("تم تحديث الشارة بنجاح"));
    }

    @DeleteMapping("/delete/{id}")
    public ResponseEntity<?> delete(@PathVariable Integer id) {
        badgeService.deleteBadge(id);
        return ResponseEntity.ok(new ApiResponse("تم حذف الشارة بنجاح"));
    }
