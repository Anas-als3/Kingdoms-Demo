...
public class ControllerAdvice {
    ...
    public ResponseEntity<?> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        return ResponseEntity.status(400).body(new ApiResponse("صيغة JSON غير صالحة"));
    }

    @ExceptionHandler(value = MissingServletRequestParameterException.class)
    public ResponseEntity<?> handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
        return ResponseEntity.status(400).body(new ApiResponse("معامل مفقود: " + e.getParameterName()));
    }
    ...
    public ResponseEntity<?> handleNoHandlerFoundException(NoHandlerFoundException e) {
        return ResponseEntity.status(400).body(new ApiResponse("نقطة الوصول غير موجودة"));
    }
    ...
    public ResponseEntity<?> handleMissingPathVariableException(MissingPathVariableException e) {
        return ResponseEntity.status(400).body(new ApiResponse("متغير المسار مفقود: " + e.getVariableName()));
    }
